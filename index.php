...
<body class=''>
    <div class="bgimg">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <a class="navbar-brand ml-5" href="#">LMS</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link ml-5" href="#">Workbooks</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row text-dark">
                    <div class="col-md-12 col-lg-6">
                        ...
                        <div class="hero-left-wrap"> <br><br>
                            ...
                            <p class="hero-subtitle  mb-4">
                                Learn your favorite course, build your skills. <br> Enrolll course online from
                    ...
                    <div class="col-md-12 col-lg-6 hero-right-col">
                        <div class="hero-right-wrap">
                            <img src="https://demo.themeqx.com/teachify-lms/public/themes/edugator/images/hero-image.png"
                                class="img-fluid">
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="home-info-box">
                            <img
                                src="https://demo.themeqx.com/teachify-lms/public/themes/edugator/images/career-goal.svg">
                    ...
                    <div class="col-md-3">
                        <div class="home-info-box">
                            <img
                                src="https://demo.themeqx.com/teachify-lms/public/themes/edugator/images/instructions.svg">
                    ...
                    <div class="col-md-3">
                        <div class="home-info-box">
                            <img
                                src="https://demo.themeqx.com/teachify-lms/public/themes/edugator/images/cartificate.svg">
                    ...
                    <div class="col-md-12">
                        <div class="section-header-wrap">
                            <h3 class="section-title" id="courses">
                                ...
                                <a href="https://demo.themeqx.com/teachify-lms/public/featured-courses"
                                    class="btn btn-link float-right"><i class="la la-bookmark"></i> All Featured
                                    Courses</a>
                            </h3>
                        ...
                        <div class="col-md-4 course-card-grid-wrap ">
                            <div class="course-card mb-5 bg-white border shadow">
                                ...
                                <div class="course-card-img-wrap">
                                    <a
                                        href="https://demo.themeqx.com/teachify-lms/public/courses/management-skills-new-manager-training-in-essential-skills">
                                        <img src="https://demo.themeqx.com/teachify-lms/public/uploads/images/image_sm/aws-learn.jpg"
                                ...
                                <div class="course-card-contents  p-4 ">
                                    <a
                                        href="https://demo.themeqx.com/teachify-lms/public/courses/management-skills-new-manager-training-in-essential-skills">
                                        <h5 class=" mb-3"><?php echo $out['name']?>
                                        </h5>
                                    </a>
                        ...
                        $output1 = mysqli_fetch_assoc($data1); echo $output1['name'] ?>
                                    ...
                                    <div class="course-card-footer mt-3">
                                        <div class="course-card-cart-wrap d-flex justify-content-between">
                                            <div class="price-html-wrap  current-price-left "> <span
                                                    class="current-price">$15.00</span> <span
                                                    class="old-price"><s>$119.00</s></span></div>

                                            <div class="course-card-btn-wrap">
                                                <a class="btn btn-primary btn-sm mr-2 text-white"
                                                    href="stripe_payment_getway_php/index.php?valid=30" role="button">
