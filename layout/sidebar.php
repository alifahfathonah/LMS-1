...
<li class="nav-item">
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="employees.php"> Add New Admin</a>
            <a class="collapse-item" href="employee_sale.php">View Admins</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="employees.php"> Add New Instructor</a>
            <a class="collapse-item" href="employee_sale.php">View Instructors</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="customers.php">Add New Student</a>
            <a class="collapse-item" href="borrow_payment.php">View Students</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="login.html">Sale</a>
