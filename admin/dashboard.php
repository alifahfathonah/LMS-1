...
$sql3=mysqli_query($conn, "SELECT * FROM workbook ");
$data3=mysqli_num_rows($sql3);
$sql4=mysqli_query($conn, "SELECT * FROM lisence ");
$data4=mysqli_num_rows($sql4);
$sql5=mysqli_query($conn, "SELECT * FROM lisence WHERE status='active'");
$data5=mysqli_num_rows($sql5);
$active=($data5/$data4) *100;
$p_active=round($active);
$sql6=mysqli_query($conn, "SELECT * FROM groups");
...
?>
<body id="page-top">
<input type="hidden" id="u1" value="<?php echo $rows?>">
<input type="hidden" id="u2" value="<?php echo $data1?>">
<input type="hidden" id="u3" value="<?php echo $data2?>">
    <!-- Page Wrapper -->
    <div id="wrapper">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Active Liscense
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $p_active?>%</div>
                                                </div>
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                                                        <div class="progress-bar bg-info" role="progressbar"
                                                            style="width: <?php echo $p_active?>%" aria-valuenow="<?php echo $p_active?>" aria-valuemin="0"
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                Total Groups</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $data6?></div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <!-- <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Monile Oil <span
                                            class="float-right">20%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: 20%"
                                            aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Petrol <span
                                            class="float-right">40%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 40%"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Diesel <span
