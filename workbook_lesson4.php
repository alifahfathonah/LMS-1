     ...
     <img src="img/h1.png" class="hd-img" alt="">
              ...
              <div class="scenario pt-5 ml-5 text-dark">
               ...
               <img src="img/q1.png" alt="">    <span> <b>	Which ways of refusing worked the best? Why? </b></span>
                <textarea class="txtarea ml-5" name="rq1" id="" cols="100" rows="3"></textarea>
              </div>
              </div>
     ...
     <div class="bg" style='background-image:url(img/bg2.jpg); background-size:cover; '>
        <div class="lesson4-2 <?php echo $dlesson2?>" style='background-color:rgba(0,0,0,0.7)'>
              ...
              <div class="r  px-5  " style="display:flex; color:black">
                ...
                <input type="text" name="bq1" class='txtarea mt-4' size="20">
                <textarea name="bq2" class='txtarea mt-4'id="" cols="21" rows="5"></textarea>
                <textarea name="bq3" class='txtarea mt-4'id="" cols="21" rows="5"></textarea> <br> <br> 

               <span class='text-white mt-5'> <input type="radio" name='bq4' value="Assertive"> Assertive <br>
                <input type="radio" name='bq4' value="Passive"> Passive <br>
                <input type="radio" name='bq4' value="Aggressive"> Aggressive </span>
                </div>
                <div class="clm3" style="flex:1">
                <img src="img/q2.png" class='ml-5 pl-3' alt="">
                <input type="text" name="bq5"  class='txtarea mt-4' size="20">
                <textarea name="bq6" class='txtarea mt-4'id="" cols="21" rows="5"></textarea>
                <textarea name="bq7" class='txtarea mt-4'id="" cols="21" rows="5"></textarea>
                <br> <br> 

               <span class='text-white mt-5'> <input type="radio" name='bq8' value="Assertive"> Assertive <br>
                <input type="radio" name='bq8' value="Passive"> Passive <br>
                <input type="radio" name='bq8' value="Aggressive"> Aggressive </span>
                </div>
                <div class="clm3" style="flex:1">
                <img src="img/q3.png"  class='ml-5 pl-3'alt="">
                <input type="text" name="bq9"  class='txtarea mt-4' size="20">
                <textarea name="bq10" class='txtarea mt-4'id="" cols="21" rows="5"></textarea>
                <textarea name="bq11" class='txtarea mt-4'id="" cols="21" rows="5"></textarea>
                <br> <br> 

               <span class='text-white mt-5'> <input type="radio" name='bq12' value="Assertive"> Assertive <br>
                <input type="radio" name='bq12' value="Passive"> Passive <br>
                <input type="radio" name='bq12' value="Aggressive"> Aggressive </span>
                </div>
                <div class="clm3" style="flex:1">
                <img src="img/q4.png"class='ml-5 pl-3' alt="">
                <input type="text" name="bq13"  class='txtarea mt-4' size="20">
                <textarea name="bq14" class='txtarea mt-4'id="" cols="21" rows="5"></textarea>
                <textarea name="bq15" class='txtarea mt-4'id="" cols="21" rows="5"></textarea>
                <br> <br> 

               <span class='text-white mt-5'> <input type="radio" name='bq16' value="Assertive"> Assertive <br>
                <input type="radio" name='bq16' value="Passive"> Passive <br>
                <input type="radio" name='bq16' value="Aggressive"> Aggressive </span> 
                </div>
              </div>
            <br> <br>
