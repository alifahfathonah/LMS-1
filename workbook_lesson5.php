   ...
   <div class=" lesson5-1 <?php echo $dlesson1?>" style='color:black; margin-top:6rem'>
              ...
              <br> 
               ...
               <form action="" method="post">
                <img src="img/q1.png" class='float-left p-2'alt=""> <span > <b>A food I don't like is: </b> </span> <input type="text" name="q1a" class='txtarea p-1' size="72" id=""><br>
                <span > <b>Why?</b> <textarea name="q1b" class='txtarea' id="" cols="70" rows="5"></textarea><br> <br>
                <img src="img/q2.png" class='float-left p-2'alt=""> <span > <b>	An activity I don’t like to do is: </b> </span> <input type="text" name="q2a" class='txtarea p-1' size="35" id=""><br>
                <span > <b>Why?</b> </span> <textarea name="q2b" class='txtarea' id="" cols="70" rows="5"></textarea> <br> <br>
                <img src="img/q3.png" class='float-left p-2'alt=""> <span > <b>Something I dislike that might hurt my future is: </b> </span> <input type="text" name="q3a" class='txtarea p-1' size="20" id=""><br>
                <span > <b>Why?</b> </span> <textarea name="q3b" class='txtarea' id="" cols="70" rows="5"></textarea> <br> <br>
     ...
     <!-- //Main Heading LESSON 5.2--> <br>
        <div class="lesson3-3 <?php echo $dlesson2?>" style="color:black">
              ...
              <div class="scenario px-5 ml-5 mt-4 ">
                ...
                <textarea class="txtarea" name="qs1" id="" cols="100" rows="2"></textarea> <br><br>
              </div>
              </div>
              <div class="scenario px-5 ml-5 ">
                ...
                <textarea class="txtarea" name="qs2" id="" cols="100" rows="2"></textarea> <br><br>
              </div>
              </div>
              <div class="scenario px-5 ml-5 ">
                ...
                <textarea class="txtarea" name="qs3" id="" cols="100" rows="2"></textarea> <br><br>
              </div>
              </div>
              <div class="scenario px-5 ml-5">
                ...
                <textarea class="txtarea" name="qs4" id="" cols="100" rows="2"></textarea> <br><br>
              </div>
              </div>
              <div class="scenario px-5 ml-5 ">
                ...
                <textarea class="txtarea" name="qs5" id="" cols="100" rows="2"></textarea> <br><br><br><br>
              </div>
              </div>
